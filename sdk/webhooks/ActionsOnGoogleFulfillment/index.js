...
const INSTRUCTIONS = 'Hello user, Do you want me to change color or pause spinning? ' +
...
app.handle('welcome', (conv) => {
  ...
  conv.add('Welcome User, I will be your new best friend! Do you want me to change color or pause spinning? ' +
    'You can also tell me to ask you later.');
  conv.add(new Canvas({
